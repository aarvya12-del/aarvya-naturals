      ...
      <div className="mx-auto max-w-[1500px] px-6">
        ...
        <div className="text-center">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-gray-600">
            Premium quality products, hygienically packed and delivered with
            care to help you embrace a healthier lifestyle every day.
          </p>
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          {features.map((feature) => {
            ...
            return (
              <div
                key={feature.title}
                className="group flex h-full flex-col rounded-3xl border border-gray-200 bg-white p-8 shadow-md transition-all duration-300 hover:-translate-y-2 hover:border-[#C9A227] hover:shadow-2xl"
              >
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-blue-100 transition-colors duration-300 group-hover:bg-[#0B3C8C]">

                  <Icon
                    size={32}
                    className="text-[#0B3C8C] transition-colors duration-300 group-hover:text-white"
                  />
        ...
        <div className="mt-20 rounded-3xl bg-[#0B3C8C] px-10 py-16 text-center text-white">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-5">
            ...
            <Link
              href="/products"
              className="rounded-full bg-[#C9A227] px-8 py-4 font-semibold text-black transition-all duration-300 hover:scale-105 hover:shadow-xl"
            >
              Shop Products
            </Link>
            ...
            <a
              ...
              className="rounded-full border-2 border-white px-8 py-4 font-semibold text-white transition-all duration-300 hover:bg-white hover:text-[#0B3C8C]"
            >
              WhatsApp Us
            </a>
